...
{
    /// <inheritdoc />
    public partial class updatedata13 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "通過", 17, 2, "貓咪玩耍技巧", 1, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(586), "教您如何培養貓咪的遊戲技巧和互動能力，以及運動與娛樂訓練。", 0, 2, 1, 2, 120m, "/Img/CourseThumbnail/course3.jpg", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(586) },
                    { 3, "通過", 25, 2, "狗狗攝食指導", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(614), "教您如何給予狗狗均衡的飲食和營養，以維持健康和活力。", 0, 3, 2, 1, 90m, "/Img/CourseThumbnail/course4.jpg", 3, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(614) },
                    { 4, "通過", 14, 2, "狗狗社交訓練", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(616), "幫助您的狗與其他狗和人建立友好的關係，減少焦慮和攻擊行為。", 0, 4, 3, 1, 80m, "/Img/CourseThumbnail/course5.jpg", 4, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(617) },
                    { 5, "通過", 19, 1, "貓咪基礎訓練", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(619), "學習如何訓練您的貓咪做到基本的動作，例如使用貓砂盆和對聲音指令的回應。", 0, 5, 2, 2, 110m, "/Img/CourseThumbnail/course6.jpg", 5, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(619) },
                    { 6, "通過", 12, 1, "狗狗運動訓練", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(621), "訓練狗狗進行各種運動，如擲球、跑步和障礙訓練，以增強體力和耐力。", 0, 6, 5, 1, 70m, "/Img/CourseThumbnail/course1.jpg", 6, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(621) },
                    { 7, "通過", 23, 2, "貓咪心理療法", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(623), "介紹貓咪的心理狀態和行為問題，並提供治療和紓解方法。", 0, 7, 3, 2, 100m, "/Img/CourseThumbnail/course2.jpg", 7, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(624) },
                    { 8, "通過", 18, 2, "狗狗護理實務", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(626), "學習如何給予狗狗良好的護理，包括洗澡、梳毛、剪指甲等日常護理技巧。", 0, 8, 2, 1, 130m, "/Img/CourseThumbnail/course3.jpg", 8, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(626) },
                    { 9, "通過", 20, 2, "貓咪飲食指導", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(629), "指導您如何挑選合適的貓咪食品，以及如何處理貓咪的特殊飲食需求。", 0, 9, 6, 2, 95m, "/Img/CourseThumbnail/course4.jpg", 9, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(629) },
                    { 10, "通過", 16, 2, "狗狗心理訓練", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(631), "透過心理學原理，幫助您了解和解決狗狗的行為問題，提高狗狗的心理健康。", 0, 15, 6, 1, 85m, "/Img/CourseThumbnail/course1.jpg", 10, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(631) },
                    { 11, "通過", 16, 2, "貓咪攝食指南", 1, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(633), "提供關於貓咪飲食、營養和餵食方式的專業指導和建議。", 0, 10, 1, 2, 85m, "/Img/CourseThumbnail/course4.jpg", 1, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(633) },
                    { 12, "通過", 22, 2, "狗狗訓練工具應用", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(635), "介紹和示範各種訓練工具的使用方法，如點擊器、項圈和玩具。", 0, 11, 2, 1, 75m, "/Img/CourseThumbnail/course2.jpg", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(636) },
                    { 13, "通過", 23, 2, "貓咪健康檢查", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(638), "教您如何給貓咪進行基本的健康檢查，包括檢查牙齒、耳朵和毛皮。", 0, 12, 3, 2, 80m, "/Img/CourseThumbnail/course5.jpg", 3, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(638) },
                    { 14, "通過", 19, 2, "狗狗行為矯正", 1, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(640), "幫助您了解狗狗的不良行為根源，並提供有效的矯正和改善方法。", 0, 13, 1, 1, 90m, "/Img/CourseThumbnail/course3.jpg", 4, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(640) },
                    { 15, "通過", 20, 2, "貓咪社交化培訓", 2, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(643), "教您如何幫助貓咪建立社交技巧，與其他貓咪和人類和睦相處。", 0, 14, 5, 2, 100m, "/Img/CourseThumbnail/course1.jpg", 5, new DateTime(2024, 5, 14, 8, 33, 17, 714, DateTimeKind.Utc).AddTicks(643) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, new DateTime(1988, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "lin@example.com", false, false, "吳偉昌", "0912345678", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(708), "新北市" },
                    { 3, new DateTime(1992, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "zhang@example.com", false, false, "黃文彥", "0922334455", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(710), "台中市" },
                    { 4, new DateTime(1997, 6, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "chen@example.com", false, false, "張明志", "0955667788", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(711), "高雄市" },
                    { 5, new DateTime(1985, 9, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "li@example.com", false, false, "許淑惠", "0933123456", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(713), "桃園市" },
                    { 6, new DateTime(1980, 12, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "wu@example.com", false, false, "李志明", "0977889900", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(714), "台南市" },
                    { 7, new DateTime(1990, 7, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "xu@example.com", false, false, "徐宜真", "0911223344", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(715), "基隆市" },
                    { 8, new DateTime(1983, 2, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "cai@example.com", false, false, "蔡文偉", "0988777666", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(717), "新竹市" },
                    { 9, new DateTime(1993, 4, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "qiu@example.com", false, false, "楊宜真", "0966888999", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(718), "嘉義市" },
                    { 10, new DateTime(1998, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "ye@example.com", false, false, "陳志宏", "0944556677", null, new DateTime(2024, 5, 14, 16, 33, 17, 714, DateTimeKind.Local).AddTicks(719), "臺北市" }
                });
