    ...
    public class ProjectDbContext : DbContext
    {
        ...
        .IsRequired(false); // 設定為允許null
            ...
            modelBuilder.Entity<Course>().HasData(
               new Course { CourseID = 1, CourseName = "幼犬訓練", TrainerID = 1, PetCategory = "狗", CourseCategory = "技能", CourseType = "一對一", Description = "幼犬基本訓練", ApprovalStatus = "通過", Price = 100, Location = "台北", MaxParticipants = 1, EnrollmentCount = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Clicks = 21 },
               new Course { CourseID = 2, CourseName = "幼犬訓練", TrainerID = 1, PetCategory = "狗", CourseCategory = "技能", CourseType = "一對一", Description = "幼犬基本訓練", ApprovalStatus = "通過", Price = 100, Location = "台北", MaxParticipants = 1, EnrollmentCount = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Clicks = 21 },
               new Course { CourseID = 3, CourseName = "幼犬訓練", TrainerID = 1, PetCategory = "狗", CourseCategory = "技能", CourseType = "一對一", Description = "幼犬基本訓練", ApprovalStatus = "通過", Price = 100, Location = "台北", MaxParticipants = 1, EnrollmentCount = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Clicks = 21 },
               new Course { CourseID = 4, CourseName = "幼犬訓練", TrainerID = 1, PetCategory = "狗", CourseCategory = "技能", CourseType = "一對一", Description = "幼犬基本訓練", ApprovalStatus = "通過", Price = 100, Location = "台北", MaxParticipants = 1, EnrollmentCount = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Clicks = 21 },
               new Course { CourseID = 5, CourseName = "幼犬訓練", TrainerID = 1, PetCategory = "狗", CourseCategory = "技能", CourseType = "一對一", Description = "幼犬基本訓練", ApprovalStatus = "通過", Price = 100, Location = "台北", MaxParticipants = 1, EnrollmentCount = 0, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Clicks = 21 }
            );
