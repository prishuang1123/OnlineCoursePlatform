    ...
    public class HomeController : Controller
    {
        ...
        public async Task<JsonResult> GetQuantity()
        {
            var quantityTotals = _ProjectDbContext.OrderDetail
                ...
                .Select(g => new { CourseID = g.Key, TotalQuantity = g.Sum(x => x.Quantity) }); // å°‡çµæžœè½‰æ›ç‚º List
        ...
        {
            // æŸ¥è¯¢ Trainer è¡¨ä¸­åŒ¹é… TrainerName çš„æ•°æ®
            ...
            // è¿”å›žéƒ¨åˆ†è§†å›¾ï¼Œå¹¶å°†æŸ¥è¯¢ç»“æžœä¼ é€’ç»™è§†å›¾
